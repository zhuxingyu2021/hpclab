...
#pragma omp for
    for ( i = 1; i < M - 1; i++ )
    {
       ...
       */
    parallel_for(1, M - 1, 1, [](void* pf_args) -> void* {
...
#pragma omp for
    ...
    parallel_for(0, N, 1, [](void* pf_args) -> void* {
        double (*_w)[N] = PF_GET_ARG(pf_args, double(*)[N]);
...
*/
        ...
        parallel_for(0, M, 1, [](void* pf_args) -> void*{
